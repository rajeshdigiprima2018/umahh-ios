...
class PersonangeVC: UIViewController,UITableViewDelegate,UITableViewDataSource  {
    ...
    func personnageListApi(){
        ...
        let urlPath =  "http://167.172.131.53:4002/api/mosque/getpersonnage"
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath){
         self.navigationController!.pushViewController(PersonnageVC(nibName: "PersonnageVC", bundle: nil), animated: true)
    }
