...
class QuranDetailVC: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func setViews()
    {
        ...
        let quran_name:String = UserDefaults.standard.object(forKey: "quran_name") as! String
        print(quran_name)
        
        appDelegate.setNavigationBarStyleWithTransparent(navigationController: navigationController!, viewController: self, title: quran_name)
...
//    }
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.lblCount.text = "\(indexPath.row  + 1)"// diccat["number"].stringValue
        ...
        if selectValue == "0" {
            cell.viewMain.backgroundColor = UIColor.appGrayColor()
             ...
             cell.viewMain.backgroundColor = UIColor.appThemeLightBlueColor()
        }
